...
MEGATRON_OPEN_SCI_PATH="/scratch/project_462000963/users/pyysalos/Megatron-LM-Open-Sci"
...
curl https://raw.githubusercontent.com/LAION-AI/Open-Sci-hf/refs/heads/main/sample/modeling_opensci.py > "$OUTDIR/modeling_opensci.py"
curl https://raw.githubusercontent.com/LAION-AI/Open-Sci-hf/refs/heads/main/sample/configuration_opensci.py > "$OUTDIR/configuration_opensci.py"
